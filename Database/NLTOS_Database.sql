...
begin
EXEC [NLTOS].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [NLTOS] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [NLTOS] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [NLTOS] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [NLTOS] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [NLTOS] SET ARITHABORT OFF 
GO
ALTER DATABASE [NLTOS] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [NLTOS] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [NLTOS] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [NLTOS] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [NLTOS] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [NLTOS] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [NLTOS] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [NLTOS] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [NLTOS] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [NLTOS] SET  DISABLE_BROKER 
GO
ALTER DATABASE [NLTOS] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [NLTOS] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [NLTOS] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [NLTOS] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [NLTOS] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [NLTOS] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [NLTOS] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [NLTOS] SET RECOVERY FULL 
GO
ALTER DATABASE [NLTOS] SET  MULTI_USER 
GO
ALTER DATABASE [NLTOS] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [NLTOS] SET DB_CHAINING OFF 
GO
ALTER DATABASE [NLTOS] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [NLTOS] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [NLTOS] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [NLTOS] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
EXEC sys.sp_db_vardecimal_storage_format N'NLTOS', N'ON'
GO
ALTER DATABASE [NLTOS] SET QUERY_STORE = ON
GO
ALTER DATABASE [NLTOS] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
USE [NLTOS]
GO
