        ...
        public bool Save()
        {
            ...
            switch (Mode)
            {
                ...
                case enMode.Update:
                    ...
                    //the application row and the licence row describe one issued licence
                    //between them, so they are updated in one call that shares a
                    //transaction in the data access layer, rather than saving the base
